...
@NamedQueries({@NamedQuery(name="Dose.findAll", query="SELECT d FROM Dose d")
,@NamedQuery(name="Dose.findDoesByName", query="SELECT d FROM Dose d where d.doesName=:doesName")
,@NamedQuery(name="Dose.findDoesNameAutoComplete", query="SELECT d.doesName FROM Dose d where d.doesName LIKE :doesName")})
