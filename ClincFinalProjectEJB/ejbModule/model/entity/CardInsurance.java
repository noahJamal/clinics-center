...
@NamedQueries({@NamedQuery(name="CardInsurance.findAll", query="SELECT c FROM CardInsurance c")
,@NamedQuery(name="CardInsurance.findAllByName", query="SELECT c FROM CardInsurance c where c.cardName=:cardName")
})
