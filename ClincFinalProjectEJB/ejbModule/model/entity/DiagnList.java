...
@NamedQueries({@NamedQuery(name="DiagnList.findAll", query="SELECT d FROM DiagnList d")
,@NamedQuery(name="DiagnListByVisitPainetName.findAll", query="SELECT d FROM DiagnList d where d.patient.patFName=:patFName and d.patient.patMName=:patMName and  d.patient.patLName=:patLName ")
,@NamedQuery(name="DiagnList.findByClinicName", query="SELECT d FROM DiagnList d where d.clinicCenter.cliName=:clinName")
,@NamedQuery(name="DiagnList.findVisitId", query="SELECT d FROM DiagnList d where d.patientVisit.visId=:visId")})
