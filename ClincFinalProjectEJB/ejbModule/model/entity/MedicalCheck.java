...
@NamedQueries({@NamedQuery(name="MedicalCheck.findAll", query="SELECT m FROM MedicalCheck m")
,@NamedQuery(name="MedicalCheck.findByName", query="SELECT m FROM MedicalCheck m where m.medchkName=:medCheckName")})
