...
@NamedQueries({@NamedQuery(name="PatientVisit.findAll", query="SELECT p FROM PatientVisit p")
,@NamedQuery(name="PatientVisit.findByVisitName", query="SELECT p FROM PatientVisit p where p.visName=:visName")
,@NamedQuery(name="PatientVisit.findByDate", query="SELECT p FROM PatientVisit p where p.visDate=:visDate")
,@NamedQuery(name="PatientVisit.findDoctorByName", query="SELECT p FROM PatientVisit p where p.doctor.dcoName=:docName")
,@NamedQuery(name="PatientVisit.findAllClinicName", query="SELECT p FROM PatientVisit p where p.clinicCenter.cliName=:clinName")
,@NamedQuery(name="PatientVisit.findByPatientName", query="SELECT p FROM PatientVisit p where p.patient.patFName=:patFName and p.patient.patMName=:patMName and p.patient.patLName=:patLName")
})
