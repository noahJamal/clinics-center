...
@Entity
@Table(name="MEDICINE")
@NamedQueries({@NamedQuery(name="Medicine.findAll", query="SELECT m FROM Medicine m")
,@NamedQuery(name="Medicine.findByName", query="SELECT m FROM Medicine m where m.medName=:medName")
,@NamedQuery(name="Medicine.findByMedSName", query="SELECT m FROM Medicine m where m.medSName=:medSName")
,@NamedQuery(name="Medicine.findByNameAutoComplete", query="SELECT m.medName FROM Medicine m where m.medName LIKE :medName")
,@NamedQuery(name="Medicine.findByMedSNameAutoComplete", query="SELECT m.medSName FROM Medicine m where m.medSName LIKE :medSName")})
