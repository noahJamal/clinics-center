...
@NamedQueries({@NamedQuery(name="InsuranceCompany.findAll", query="SELECT i FROM InsuranceCompany i")
,@NamedQuery(name="InsuranceCompany.findAllByName", query="SELECT i FROM InsuranceCompany i where i.compName=:compName")
})
