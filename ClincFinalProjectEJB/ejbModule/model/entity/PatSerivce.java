...
@NamedQueries({@NamedQuery(name="PatSerivce.findAll", query="SELECT p FROM PatSerivce p")
,@NamedQuery(name="PatSerivce.findByName", query="SELECT p FROM PatSerivce p where p.serName=:serName")})
