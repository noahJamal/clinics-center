...
,@NamedQuery(name="ClinicCenter.findClinicAutoId", query="SELECT c FROM ClinicCenter c where c.cliId LIKE :autoID")
,@NamedQuery(name="ClinicCenter.findNameAndID", query="SELECT c.cliId,c.cliName FROM ClinicCenter c")})
