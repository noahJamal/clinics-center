...
@NamedQueries({@NamedQuery(name="Diagnosi.findAll", query="SELECT d FROM Diagnosi d")
,@NamedQuery(name="Diagnosi.findByDaigName", query="SELECT d FROM Diagnosi d where d.digName=:daigName")
})
